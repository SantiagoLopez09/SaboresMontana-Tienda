    ...
    for (let i = 0; i < botonesOrden.length; i++) {
        if (i == 0) {
            botonesOrden[0].addEventListener("click", () => {
                let productoFiltrado = filtrarPorCategoria(productos, "Bebidas Frias")
                mostrarPorductos(productoFiltrado)
            })
        } else if (i == 1) {
            botonesOrden[1].addEventListener("click", () => {
                let productoFiltrado = filtrarPorCategoria(productos, "Bebidas Calientes")
                mostrarPorductos(productoFiltrado)
            })
        } else if (i == 2) {
            botonesOrden[2].addEventListener("click", () => {
                let productoFiltrado = filtrarPorCategoria(productos, "Panaderia")
                mostrarPorductos(productoFiltrado)
            })
        } else if (i == 3) {
